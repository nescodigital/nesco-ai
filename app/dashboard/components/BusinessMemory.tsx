      ...
      {showReminder && (
        ...
        >
          ...
          <p className="text-[13px] text-white/60 flex-1" style={{ fontFamily: "var(--font-geist-sans)" }}>
            Ai ceva nou în business săptămâna asta?
          </p>
          <button
      ...
      >
        ...
        {updates.length === 0 && !showAdd && (
          <p className="text-[12px] mb-3" style={{ color: "rgba(255,255,255,0.2)" }}>
            Nicio noutate activă. Adaugă ce s-a schimbat în business — lansări, promoții, events.
          </p>
        )}
        ...
        {showAdd && (
          <div className="flex gap-2 mb-3">
            <input
              ...
              placeholder="ex. Am lansat colecția de primăvară, Reducere 20% weekend..."
              autoFocus
