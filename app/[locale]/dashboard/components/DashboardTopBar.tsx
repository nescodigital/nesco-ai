  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "8px", fontFamily: "var(--font-geist-sans)" }}>
      ...
      <div style={{
        ...
        <span className="hidden sm:inline" style={{ color: "rgba(255,255,255,0.35)", fontSize: "11px" }}>{t("credits")}</span>
      </div>
      ...
      <a href="/pricing" className="sm:hidden flex items-center justify-center" title={t("buyTitle")} style={{
