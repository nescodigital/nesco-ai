          ...
          {!isPro ? (
            ...
            <div>
              <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.4)", margin: "0 0 12px", lineHeight: 1.5 }}>
                {t("setupDesc", { min: MIN_SAMPLES, max: MAX_SAMPLES })}
              </p>
                ...
                {samples.map((sample, i) => (
                  <div key={i} style={{ position: "relative" }}>
                    <textarea
                      ...
                      placeholder={t("textPlaceholder", { index: i + 1 })}
                      rows={3}
                      style={{
              ...
              <div style={{ display: "flex", gap: "8px", alignItems: "center", flexWrap: "wrap" }}>
                ...
                >
                  ...
                  ) : filledCount < MIN_SAMPLES ? t("analyzeBtnCount", { filled: filledCount, min: MIN_SAMPLES }) : t("analyzeBtn")}
                </button>
