    ...
    >
      ...
      <div style={{ padding: "14px", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "8px" }}>
          ...
          <span style={{ fontSize: "12px", fontWeight: 700, color: "#fff" }}>{t("referral.title")}</span>
          <span style={{
            ...
            {referral.totalReferred > 0 && (
              <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.3)", margin: 0 }}>
                {referral.totalReferred === 1
                  ? t("referral.invited", { count: referral.totalReferred })
                  : t("referral.invitedPlural", { count: referral.totalReferred })}
                {referral.totalRewarded > 0 && ` · ${t("referral.rewarded", { count: referral.totalRewarded })}`}
              </p>
            )}
          </>
        ) : (
